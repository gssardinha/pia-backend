...
def activate_license_for_subscription(customer_email, customer_id, subscription_id):
    ...
    # If this customer already has a license, reuse it
    existing_key = None
...
def stripe_webhook():
    ...
    if event_type == "checkout.session.completed":
        # For subscriptions, the session will have customer + subscription
